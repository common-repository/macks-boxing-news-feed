=== Mack's Boxing News Feed ===
Contributors: mackbincroft
Donate link: http://www.jawer.org
Tags: box, boxing, wba, professional boxing, fighting, martial arts, mma, ufc, wba news, boxing news, boxing results, boxing matchups, boxing fights, fight, fights
Requires at least: 2.2.1
Tested up to: 3.2.1
Stable tag: 0.5

Lists the Latest Boxing News
...
Relevant Keywords: wbo, wbo title, amateur boxing, box, boxing, wba, professional boxing, fighting, martial arts, mma, ufc, wba news, boxing news, boxing results, boxing matchups, boxing fights, fight, fights

A variety of news is available, including:
<ul>
<li>Latest Boxing and Fighting News</li>
<br />
<li>Individual Boxer News</li>
<br />
<li>New Entrants, Contract Reviews</li>
<br />
<li>WBO Fighting Rumors</li>
<br />
<li>WBO Gossip, Chat</li>
<br />
...
1. Upload `macks-boxing-news-feeed` folder to the `/wp-content/plugins/` directory.
2. Go to you plugins' control panel and then click "Activate" to turn the plugin on.
3. Then, visit your "settings" control panel (on the lower left hand side of your blog for WP versions 2.9+ ) where you will see a link for "Mack's Boxing News Feed". Click this link and then edit the settings as you like them.
